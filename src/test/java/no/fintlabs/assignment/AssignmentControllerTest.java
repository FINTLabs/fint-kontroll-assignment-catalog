...
public class AssignmentControllerTest {
    ...
    public void shouldGetDeviceGroupAssignmentsByResourceId() throws Exception {
        ...
        mockMvc.perform(get("/api/assignments/resource/1/deviceGroups")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.deviceGroupAssignments[0].id").value("20"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].name").value("Device group"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].orgUnitId").value("198"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].platform").value("IOS"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].deviceType").value("MOBILE"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].noOfMembers").value("3"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].organisationUnitName").value("School A"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].assignerUsername").value("assigner"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].assignerDisplayname").value("Assigner Name"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].assignmentRef").value("10"))
    ...
    public void shouldPageDeviceGroupAssignmentsByResourceId() throws Exception {
        ...
        mockMvc.perform(get("/api/assignments/resource/1/devicegroups?page=1&size=1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.deviceGroupAssignments[0].id").value("21"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].name").value("Second device group"))
    ...
    public void shouldSearchDeviceGroupAssignmentsByResourceId() throws Exception {
        ...
        mockMvc.perform(get("/api/assignments/resource/1/devicegroups?search=chrome")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.deviceGroupAssignments[0].id").value("21"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].name").value("Chromebook group"))
                .andExpect(jsonPath("$.deviceGroupAssignments[0].assignmentRef").value("11"))
                .andExpect(jsonPath("$.totalItems").value("1"))
                .andExpect(jsonPath("$.currentPage").value("0"))
                .andExpect(jsonPath("$.size").value("20"));
